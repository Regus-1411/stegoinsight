 ...
 * IntroScreen.jsx
 * ─────────────────────────────────────────────────────────────
 * Cinematic intro splash for StegoShield.
...
const STATUS_LINES = [
    ...
    "ML-based steganography detection using Logistic Regression",
    "Classifies images as Stego or Non-Stego",
    "Generates probability scores for clear interpretation",
    "Results visualized through confidence meters"
...
export default function IntroScreen({ onComplete, duration = T.AUTO_EXIT }) {
    ...
    const exit = () => {
        ...
        setTimeout(() => {
            setPhase("done");
            // Navigate to landing page instead of calling onComplete
            navigate("/landing");
            onComplete?.();
        }, T.EXIT_DURATION + 100);
    };
